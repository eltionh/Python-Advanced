...
st.write('This app analyzes the amazon top selling books from 2008 to 2022')
...
fig = px.bar(top_authors, x='Count', y='Author', orientation='h', title='Top 15 Authors by Counts of Books Published', color='Count',
